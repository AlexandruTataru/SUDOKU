...
def testDLL():
    ...
    #Arto Inkala
    #values = [8, 3, 6, 7, 9, 2, 5, 7, 4, 5, 7, 1, 3, 1, 6, 8, 8, 5, 1, 9, 4]
    #positions = [0, 11, 12, 19, 22, 24, 28, 32, 40, 41, 42, 48, 52, 56, 61, 62, 65, 66, 70, 73, 78]

    #AI Escargot
    #values = [1, 7, 9, 3, 2, 8, 9, 6, 5, 5, 3, 9, 1, 8, 2, 6, 4, 3, 1, 4, 1, 7, 7, 3]
    #positions = [0, 5, 7, 10, 13, 17, 20, 21, 24, 29, 30, 33, 37, 40, 44, 45, 50, 54, 61, 64, 65, 71, 74, 78]
